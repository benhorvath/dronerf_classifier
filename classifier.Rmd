...
```{r}
m0_pred <- predict(m0, train)
m1_pred <- predict(m1, train)

confusionMatrix(m0_pred, train$y)
confusionMatrix(m1_pred, train$y)
...
```{r}
m2_pred <- predict(m2, train)

confusionMatrix(m2_pred, train$y)
```
